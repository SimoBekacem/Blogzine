		...
		return (
			<div className="TopToday__items__item" key={item.id}>
				...
				<div className="TopToday__items__item__text">
					{item.isSponsored ? (
						<div className="TopToday__items__item__img__sponsored">
							Sponsored
						</div>
					) : null}
					<h3>{item.title}</h3>
	...
	return (
		<div className="TopToday">
			<div className="TopToday__title">
				<h2>
					<i className="fa-solid fa-hourglass-start"></i>Today's top
					highlights
				</h2>
				<p>
			...
			<div className="TopToday__items">{TopTodayItems}</div>
